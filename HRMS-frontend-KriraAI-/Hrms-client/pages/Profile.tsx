...
export const Profile: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            {/* Salary Information Card - Only visible to Admin and HR */}
                                                ...
                                                <tr key={index} className={`${isPaid ? 'bg-green-50' :
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <div className="flex items-center gap-2">
                                                            {isCurrent ? (
                                                                <>
                                                                    <span className="font-bold text-green-600 text-sm min-w-[70px]">
                                                                        {isSalaryVisible 
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        onMouseDown={() => setIsSalaryVisible(true)}
                                                                        onMouseUp={() => setIsSalaryVisible(false)}
                                                                        onMouseLeave={() => setIsSalaryVisible(false)}
                                                                        onTouchStart={() => setIsSalaryVisible(true)}
                                                                        onTouchEnd={() => setIsSalaryVisible(false)}
                                        ...
                                        <div className="flex items-start gap-3 flex-1">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                                                    ...
                                                    <div>
                                                        <p className="text-xs text-gray-500 font-semibold">{bond.type === 'Internship' ? 'Stipend' : 'Salary'}</p>
                                                        <p className="text-sm font-bold text-green-600 mt-0.5">
                                                            ₹{(bond.salary || 0).toLocaleString('en-IN')}
                                                        </p>
                                                    </div>
                                                    <div>
