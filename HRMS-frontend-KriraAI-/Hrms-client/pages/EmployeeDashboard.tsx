...
import { getTodayStr, formatDuration, formatTime, formatDate, convertToDDMMYYYY, calculateDailyTimeStats } from '../services/utils';
...
export const EmployeeDashboard: React.FC = () => {
  ...
  // Normal time: 8h 0m. Low < 8h, Extra > 8h
  const MIN_NORMAL_SECONDS = 8 * 3600; // 8 hours = 28800 seconds
  const MAX_NORMAL_SECONDS = 8 * 3600; // 8 hours = 28800 seconds
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className={`mt-2 ${isOnBreak ? 'text-amber-500' : 'text-blue-600'}`}>
                    <div className="flex items-center justify-center md:justify-start gap-1">
                      {(() => {
                        // Show break timer when on break, raw work timer when working
                        const rawDisplay = isOnBreak ? breakElapsed : elapsed;
                        const displayTime = rawDisplay;
