...
// Business Rules
// BR1: Low Time < 8:00 (480 mins), Extra Time > 8:00 (480 mins)
// BR3: Half-day reduces threshold to 4 hours (240 mins)

const LOW_TIME_THRESHOLD_MINUTES = 480; // 8h 00m
const EXTRA_TIME_THRESHOLD_MINUTES = 480; // 8h 00m
const HALF_DAY_LEAVE_MINUTES = 240; // 4h 00m credit
const HALF_DAY_LOW_THRESHOLD_MINUTES = 240; // 4h 00m
const HALF_DAY_EXTRA_THRESHOLD_MINUTES = 240; // 4h 00m
